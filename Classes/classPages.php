                        ...
                        <div class='col-md-10 col-8'>
                            <div class='card-body p-1'>
                                ...
                                {$this->openClass($session)}                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                          
                                    <span class='float-right'><a title='Deletar' aria-label='Deletar' href='{{root}}/Acoes/deletar.php?id={$fetch->id}&user={$fetch->usuario}'><i class='text-danger fa fa-trash fa-2x'></i></a></span>
                                    <span class='float-right mr-2'><a title='Editar' href='{{root}}/home/{$fetch->id}'><i class='text-info fa fa-pencil-square fa-2x' aria-hidden='true'></i></a></span>
