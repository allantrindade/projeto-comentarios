<?php
    ...
    $result = $crud->selectDB('*', 'comentarios', 'ORDER BY id desc', array());               
        ...
        <div class="col-md-2">
            <img class="img-thumbnail rounded-circle" style="width: 200px; height: 130px;" alt="Usuário" src="<?=DIR?>/Images/Usuarios/<?php if (!empty($usuario)) {echo $usuario->imagem;} else {echo 'anonimo.jpg';}?>"/>
        </div>
        <div class="col-md-10">
            <div class="card-body p-2">
                ...
                ?>                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                             
                <span class="float-right mr-2"><a href='<?php echo "./Acoes/deletar.php?id={$fetch->id}&user={$fetch->usuario}"?>'><img src="<?=DIR?>/Images/Icones/deletar.png" title="Deletar" alt="Deletar"></a></span>
                <span class="float-right mr-3"><a href='<?php echo "?id={$fetch->id}&user={$fetch->usuario}"?>'><img src="<?=DIR?>/Images/Icones/editar.png" title="Editar" alt="Editar"></a></span>
                </p>
                <?php 
                    if (($_SESSION['loggedin'] == "Usuário não Logado")){
                     echo '</div>';
